...
const uint32_t _lookupOnlyBase = _lookupExcludeBaseMods;

const uint32_t _lookupOnlyMods =  _lookupExcludeBase;

const uint32_t _lookupExcludeMods = _lookupExcludeBaseMods;
